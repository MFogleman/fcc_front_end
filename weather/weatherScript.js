...
This code is rough, hard to read, not optimal, and overall bad.  This is one of my first learning processes, and every day I'm learning new ways to make things better.  If I rewrote the code every time I found a better way to do something, it wouldn't get done.  With that in mind, if it doesn't effect the end-user, I'm probably not recoding it unless necesarry.
****/
var weatherString = '';
...
function assignWeather(result) {
  ...
  weatherUnit = 'K';
  while (weatherObj.temp == null || weatherObj.city == null || weatherObj.weather == null) {
